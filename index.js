...
function generateManager () {
  ...
  .then((managerResponse) => {
    let manager = new Manager (managerResponse.name, managerResponse.id, managerResponse.email, managerResponse.officeNumber);
...
function generateEngineer () {
  ...
  .then((engineerResponse) => {
    let engineer = new Engineer (engineerResponse.name, engineerResponse.id, engineerResponse.email, engineerResponse.github);
...
function generateIntern () {
  ...
  .then((internResponse) => {
    let intern = new Intern (internResponse.name, internResponse.id, internResponse.email, internResponse.school);
